...
from kclient.models.models_task_form_element_value import ModelsTaskFormElementValue  # noqa: F401,E501
...
class ModelsTaskFormElement(object):
    ...
    def __init__(self, elements=None, name=None, required=None, value=None, label=None, width=None, list_type=None, hidden=None, type=None, options=None):  # noqa: E501
