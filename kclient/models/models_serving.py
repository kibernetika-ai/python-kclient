...
from kclient.models.mlapp_universal_serving import MlappUniversalServing  # noqa: F401,E501
from kclient.models.models_task_form_element import ModelsTaskFormElement  # noqa: F401,E501
from kclient.models.models_task_form_element_stream_extended import ModelsTaskFormElementStreamExtended  # noqa: F401,E501
...
class ModelsServing(object):
    ...
    def __init__(self, inference_values=None, display_name=None, user_display_name=None, cluster_id=None, health=None, build=None, user_id=None, health_error=None, config=None, status=None, inference_name=None, description=None, type=None, gpu_used=None, application_display_name=None, inference_version=None, workspace_display_name=None, user_login=None, gallery=None, application_name=None, inference_form=None, task=None, name=None, picture=None, inner_address=None, containers_count=None, inference_streams=None, inference_workspace_display_name=None, id=None, status_message=None, gallery_tags=None, disabled=None, workspace_name=None, inference_workspace_name=None):  # noqa: E501
